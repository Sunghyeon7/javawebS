  ...
  <div class="w3-bar w3-black w3-card">
    ...
    <c:if test="${sLevel <= 3}">
	    ...
	    <div class="w3-dropdown-hover w3-hide-small">
	      ...
	      <div class="w3-dropdown-content w3-bar-block w3-card-4">
	        <a href="${ctp}/member/memberList" class="w3-bar-item w3-button">Member List</a>
	        <a href="${ctp}/member/memberPwdUpdate?pwdFlag=member" class="w3-bar-item w3-button">Password Update</a>
	        <a href="${ctp}/member/memberUpdate" class="w3-bar-item w3-button">Member Information Change</a>
	        <a href="javascript:memberDelete()" class="w3-bar-item w3-button">Drop out of a Website </a>
	        <c:if test="${sLevel==0}">
	        	<a href="${ctp}/admin/adminMenu" class="w3-bar-item w3-button">Admin Page</a>
	        </c:if>
	      </div>
	    </div>
