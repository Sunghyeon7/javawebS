    ...
    <pre>
    	...
    	- web.xml에 error에 필요한 설정을 미리 해두고 지정페이지로 보내준다.
    		...
    		< error - page >
    			...
    			< loaction > 에러 발생시 호출할 컨트롤러.. < / location >
    		< /error - page >
    </pre>
    <p>
    	<a href="${ctp}/000" class="btn btn-secondary" > Servlet 오류 (404) </a>
    </p>
    <p>
    	<a href="${ctp}/error500Check" class="btn btn-secondary" > Servlet 오류 (500) </a>
    </p>
  </div>
</div>
<p><br/></p>
