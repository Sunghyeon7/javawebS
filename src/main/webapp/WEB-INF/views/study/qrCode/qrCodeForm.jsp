...
<div class="container">
	...
	<div class="row">
		...
		<div class="col"><a href="${ctp}/study/qrCode/qrCodeEx3" class="btn btn-info" >티켓예매 등록</a></div>
		<div class="col"><a href="${ctp}/study/qrCode/qrCodeEx4" class="btn btn-info" >티켓예매 DB등록/확인</a></div>
	</div>
</div>
<p><br/></p>
