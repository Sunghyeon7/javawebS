...
<div class="container">
  <h2>ARIA</h2>
  <p>
    ARIA암호화 방식은 경량화된 환경 및 하드웨어 구현을 위해 최적화된 알고리즘으로, Involutional SPN 구조를 갖는 범용블록 암호화 알고리즘이다.
    ARIA가 사용하는 연산은 대부분 XOR과 같은 단순한 바이트단위연산으로, 블록크기는 128bit(총 비트수 : 256bit=32글자)이다. <br/>
    AIRA는 Academy(학계), Research Institute(연구소), Agency(정부기관)의 첫글자를 따서 만들었다.<br/>
    ARIA복호화는 복호화가 가능하다.
  </p>
  <hr/>
  <p>
