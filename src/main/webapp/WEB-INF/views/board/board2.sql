...
insert into board2 values (default,'admin','관리맨','게시판 서비스를 시작합니다.','kot5482@naver.com','www.naver.com','이곳은 게시판입니다.',default,'192.168.50.82',default,default,default);
...
create table board2Reply (
  ...
  groupId int default 0,						/* 그룹 ID(같은 댓글끼리의 그룹아이디는 같다) */
	level		int default 0,						/* 대댓글의 구분을 위한 level(원본글의 레벨은 0 대댓글은 1,2,3,....) */
